...
class TAS(object):
    ...
    def find_ub_from_2peaks(self, peak1, peak2, angles1, angles2, ei=13.5):
        ...
        if self.goniometer["type"] == "TAS":  # Y-X-Z
...
if __name__ == "__main__":
    ...
    takin_instru.find_ub_from_2peaks(
        peak1=peak1,
        peak2=peak2,
        angles1=angles1,
        angles2=angles2,

...
if __name__ == "__main__":
    ...
    qe_rez = np.array([(h, 0, 0, en) for h in q1_rez for en in en_rez])

    rez_list = hb3.cooper_nathans(hkle=qe_rez)
    ...
    # plot dispersion
    disp = model_disp(q1_list, np.zeros_like(q1_list), np.zeros_like(q1_list))

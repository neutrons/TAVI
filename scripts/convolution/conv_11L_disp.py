...
if __name__ == "__main__":
    ...
    qe_list = np.array([(1, 1, q1, en) for q1 in q1_list for en in en_list])
    ...
    qe_rez = np.array([(1, 1, l, en) for l in q1_rez for en in en_rez])
    ...
    # plot dispersion
    disp = model_disp(np.ones_like(q1_list), np.ones_like(q1_list), q1_list)

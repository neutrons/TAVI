...
foutid=fopen('hexaferrite_nuclear_300K.int','w');
%foutid2=fopen('MnWO4_magneticAF2_5K_full.int','w');
...
fprintf(foutid,'Single crystal data of Hexaferrite (hb1a)\n');
...
for i=1:length(scannum)
    ...
    if (width(i)<1.8 &widtherr(i)>0 &widtherr(i)<0.3)
